...
@Component({
  selector: 'app-recettes-abonnes',
  templateUrl: './recettes-abonnes.component.html',
  styleUrls: ['./recettes-abonnes.component.scss'],
})
export class RecettesAbonnesComponent implements OnInit {
  ...
  load(seg) {
    this.db.getDatabaseState().subscribe(rdy => {
      if (rdy) {
        ...
        this.db.loadRecetteByAbonne(date, seg);
